...
<div>
	...
	<form action="financeAudit/GetInFinanceAuditServlet" id="f1" method="post" class="form-inline">
<%--		显示 提交属性
			expense
			usersName
			startDate
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="list" id="ex" pagesize="5" requestURI="financeAudit/GetInFinanceAuditServlet">
				...
				<d:column property="expenseTotal" title="报销总金额"></d:column>
				<d:column property="financeAuditURL" title="财务审核"></d:column>
			</d:table>
		</div>
	</form>
</body>
