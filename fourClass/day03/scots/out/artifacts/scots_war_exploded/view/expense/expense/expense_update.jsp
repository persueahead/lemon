...
<body>
	...
	<form action="expense/UpdateMyExpenseServlet" id="f1" method="post"
		class="form-horizontal">
<%--		抓取属性 隐藏属性name="expenseId"  name="expenseState"
					文本框属性name="expenseTotal" name="expenseDesc"
					数组：	name="costIds"	name='detailMoneys' name='detailDescs'

			显示 detailList recordList costs expense
