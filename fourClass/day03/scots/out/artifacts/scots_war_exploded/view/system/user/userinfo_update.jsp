...
<form action="system/UpdateUserServlet" id="f1" method="post" class="form-horizontal">
				...
				<div class="form-group ">
					...
					<div class="col-xs-3 ">
						<select name="usersSex" class="form-control">
							<option ${user.usersSex=='保密'?'selected':'' } VALUE="保密" >保密</option>
							<option ${user.usersSex=='男'?'selected':'' } VALUE="男">男</option>
							<option ${user.usersSex=='女'?'selected':'' } VALUE="女">女</option>
						</select>
					</div>
				</div>
			</div>
				...
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						<select name="roleId" class="form-control">
							<option ${user.roleName=='普通员工'?'selected':'' } VALUE="1">普通员工</option><%--VALUE="1"  提交到后台接收到的值--%>
