...
<body>
	...
	<form action="salary/AddSalaryServlet" id="f1" method="post"
...
<%--
			...
			抓取
				salary  salary.salaryMonth salary.salaryBasic salaryComm
				userList  user.usersName user.usersId
		...
		<div class="row">
			...
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-3 ">
<%--				选项 选中之后即为下拉列表得值--%>
						<select class="form-control" required name="usersId" id="usersId">
