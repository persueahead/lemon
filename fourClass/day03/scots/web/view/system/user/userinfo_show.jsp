...
<form action="system/updateMyUsersServlet" id="f1" method="post" class="form-horizontal">
    ...
    <input type="hidden" name="usersId" value="${users.usersId }"/><%--id隐藏不可见--%>
    <!-- 开始1 -->
    <div class="row">
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" class="form-control" required name="usersName" value="${users.usersName }"
                           placeholder="请输入用户姓名"/>
                </div>
            </div>
        </div>
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" class="form-control" name="usersAge" value="${users.usersAge }"
                           placeholder="请输入用户年龄"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" class="form-control" name="usersPhone" value="${users.usersPhone }"
                           placeholder="请输入电话号码"/>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-5">
            <div class="form-group ">
                ...
                <div class="col-xs-9 ">
                    <input type="text" class="form-control" value="${users.usersPwd }" required name="usersPwd"
                           placeholder="请输入用户密码"/>
                </div>
            </div>
        </div>
