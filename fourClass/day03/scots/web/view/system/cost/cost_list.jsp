...
<div>
	...
	<form action="system/CostListServlet" id="f1" method="post" class="form-inline">
<%--		两个查询框--%>
...
<%--			三个功能键  分别为 跳转到servlet jsp   jquary事件--%>
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="costsList" pagesize="2" requestURI="system/CostListServlet">
				<d:column property="ck" title="<input type='checkbox'  id='all'  />"></d:column>
				<d:column property="costId" title="费用编号"></d:column>
				<d:column property="costName" title="费用项目"></d:column>
