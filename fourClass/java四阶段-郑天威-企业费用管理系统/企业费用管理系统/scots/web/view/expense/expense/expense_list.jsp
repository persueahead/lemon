...
<div>
	...
	<form action="expense/ExpenseSelectServlet" id="f1" method="post" class="form-inline">
<%--		属性userName  startDate endDate expenseName expenseState list--%>
...
<%--				<option value="2" ${expense.expenseState=='2'?'selected':'' } >经理未审核</option>--%>
...
<%--		点击查询 则提交表单--%>
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="list" pagesize="3" requestURI="expense/ExpenseSelectServlet">
