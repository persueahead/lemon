            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                                          class="dropdown-toggle"> <img class="nav-user-photo"
                                                                        src="resource/assets/avatars/user.jpg"
                    ...
                    <ul
                        ...
                        <li><a href="view/system/user/userinfo_show.jsp" target="mainframe"> <i class="icon-user"></i>
                            个人资料
                        </a></li>
...
<%--                    href="javascript:void(0)"    死链接，点击没有反应
                        icon-desktop桌面图标
                         menu-text菜单文本
                         arrow icon-angle-down下拉箭头 给他添加事件 能够实现下拉菜单，
                         bootstrap中dropdown-toggle的使用在使用时需要dropdown.js插件，调用方法如下：
                         $(function(){
                                $(".dropdown-toggle").dropdown('toggle');
                                });
--%>
                        <li><a href="javascript:void(0)" target="mainframe"
<%--                               dropdown-toggle下拉菜单切换样式--%>
                               class="dropdown-toggle"> <i class="icon-desktop"></i> <span
                                class="menu-text"> ${menu.menuName } </span> <b class="arrow icon-angle-down"></b>
                        </a>

                            <ul class="submenu">
                                <%--循环下再套一个循环  在0权限下再循环列出其所属权限--%>
                                <c:forEach var="child" items="${menuList }">
                                    <c:if test="${child.pMenuId == menu.menuId }"><%--123对应前面三个0权限的id--%>
                                        <%-- mainframe是框架名称--%>
                                        <%--a标签插在li标签里面 点击菜单列表发生地址跳转--%>
