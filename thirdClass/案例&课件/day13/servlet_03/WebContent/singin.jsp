...
<html>
	...
	<body>
		<form action="SaveSignIn?name=123" method="post">
		<!-- name 与  value 相当于键值对的形式，通过name能够获取value -->
		会员账号<input type="text" name="username" border="1px" id="a"  /><span>*</span><br />
		<em id="f"></em><br />
		邮箱地址<input type="text" border="1px" id="b" /><span>*</span><br />
		<em id="g"></em><br />
		登陆密码<input type="password" name="password" border="1px" id="c" /><span>*</span><br />
		<em id="h"></em><br />
